...
class RtfReportEngineModule(BaseModule):
    def info(self):
        return {"name": "rtf-report-engine", "description": "Report generation across JSON, HTML, PDF, and dashboard views.", "author": "OpenAI", "category": "omega", "version": "4.0"}
    ...
    async def run(self) -> ModuleResult:
        ...
        engine = next((item for item in registry["engines"] if item["name"] == "rtf-report-engine"), {})
        output = {
            "module": "omega/rtf_report_engine",
            "engine": engine,

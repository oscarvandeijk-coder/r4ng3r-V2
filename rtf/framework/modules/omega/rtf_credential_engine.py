...
class RtfCredentialEngineModule(BaseModule):
    def info(self):
        return {"name": "rtf-credential-engine", "description": "Credential analysis, password candidate generation, and pivoting.", "author": "OpenAI", "category": "omega", "version": "4.0"}
    ...
    async def run(self) -> ModuleResult:
        ...
        engine = next((item for item in registry["engines"] if item["name"] == "rtf-credential-engine"), {})
        output = {
            "module": "omega/rtf_credential_engine",
            "engine": engine,

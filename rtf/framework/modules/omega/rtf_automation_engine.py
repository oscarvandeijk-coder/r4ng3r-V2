...
class RtfAutomationEngineModule(BaseModule):
    def info(self):
        return {"name": "rtf-automation-engine", "description": "Scheduler-integrated automation and self-healing workflows.", "author": "OpenAI", "category": "omega", "version": "4.0"}
    ...
    async def run(self) -> ModuleResult:
        ...
        engine = next((item for item in registry["engines"] if item["name"] == "rtf-automation-engine"), {})
        output = {
            "module": "omega/rtf_automation_engine",
            "engine": engine,

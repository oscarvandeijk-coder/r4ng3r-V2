...
class RtfScraperEngineModule(BaseModule):
    def info(self):
        return {"name": "rtf-scraper-engine", "description": "Search, social, and document scraping with artifact normalization.", "author": "OpenAI", "category": "omega", "version": "4.0"}
    ...
    async def run(self) -> ModuleResult:
        ...
        engine = next((item for item in registry["engines"] if item["name"] == "rtf-scraper-engine"), {})
        output = {
            "module": "omega/rtf_scraper_engine",
            "engine": engine,

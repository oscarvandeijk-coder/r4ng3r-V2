...
class RtfBreachEngineModule(BaseModule):
    def info(self):
        return {"name": "rtf-breach-engine", "description": "Breach, combo-list, and credential exposure intelligence.", "author": "OpenAI", "category": "omega", "version": "4.0"}
    ...
    async def run(self) -> ModuleResult:
        ...
        engine = next((item for item in registry["engines"] if item["name"] == "rtf-breach-engine"), {})
        output = {
            "module": "omega/rtf_breach_engine",
            "engine": engine,

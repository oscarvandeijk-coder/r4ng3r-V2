...
class RtfMonitoringEngineModule(BaseModule):
    def info(self):
        return {"name": "rtf-monitoring-engine", "description": "Observability, health checks, and event telemetry.", "author": "OpenAI", "category": "omega", "version": "4.0"}
    ...
    async def run(self) -> ModuleResult:
        ...
        engine = next((item for item in registry["engines"] if item["name"] == "rtf-monitoring-engine"), {})
        output = {
            "module": "omega/rtf_monitoring_engine",
            "engine": engine,

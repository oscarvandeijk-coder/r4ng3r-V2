...
class RtfCasmEngineModule(BaseModule):
    def info(self):
        return {"name": "rtf-casm-engine", "description": "Continuous attack-surface management and validation.", "author": "OpenAI", "category": "omega", "version": "4.0"}
    ...
    async def run(self) -> ModuleResult:
        ...
        engine = next((item for item in registry["engines"] if item["name"] == "rtf-casm-engine"), {})
        output = {
            "module": "omega/rtf_casm_engine",
            "engine": engine,

...
class RtfAiEngineModule(BaseModule):
    def info(self):
        return {"name": "rtf-ai-engine", "description": "AI scoring, clustering, summarization, and identity fusion.", "author": "OpenAI", "category": "omega", "version": "4.0"}
    ...
    async def run(self) -> ModuleResult:
        ...
        engine = next((item for item in registry["engines"] if item["name"] == "rtf-ai-engine"), {})
        output = {
            "module": "omega/rtf_ai_engine",
            "engine": engine,
